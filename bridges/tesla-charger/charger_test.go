...
func TestRefreshCachedValuesWhileCharging(t *testing.T) {
	...
	if charger.cachedVitals == nil || charger.cachedLifetime == nil || charger.cachedVersion == nil {
		t.Error("cached values missing")
	}

	if !charger.cachedVitals.VehicleConnected {
		t.Error("vehicle not showing as connected")
	}
	...
	/**
		...
		Not charging
	    {"contactor_closed":false,"vehicle_connected":false,"session_s":0,"grid_v":250.3,"grid_hz":59.749,"vehicle_current_a":0.2,"currentA_a":0.0,"currentB_a":0.2,"currentC_a":0.0,"currentN_a":0.0,"voltageA_v":0.2,"voltageB_v":0.0,"voltageC_v":0.2,"relay_coil_v":0.0,"pcba_temp_c":1.3,"handle_temp_c":-1.4,"mcu_temp_c":8.6,"uptime_s":357763,"input_thermopile_uv":-59,"prox_v":0.5,"pilot_high_v":11.9,"pilot_low_v":11.9,"session_energy_wh":0.000,"config_status":4,"evse_state":1,"current_alerts":[],"evse_not_ready_reasons":[4,8,10]}

		Lifetime
		{"contactor_cycles":4,"contactor_cycles_loaded":2,"alert_count":8,"thermal_foldbacks":0,"avg_startup_temp":0.0,"charge_starts":4,"energy_wh":79588,"connector_cycles":2,"uptime_s":344373,"charging_time_s":9903}

		Version
		{"firmware_version":"24.36.3+g3f585e7b51cc72","git_branch":"HEAD","part_number":"1734412-02-D","serial_number":"1234ASDF"}
	*/
}
