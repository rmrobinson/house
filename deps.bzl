...
def go_dependencies():
    ...
    go_repository(
        name = "com_github_rafalop_sevensegment",
        importpath = "github.com/rafalop/sevensegment",
    ...
    go_repository(
        ...
        sum = "h1:f1EXLn4pkf7AEWwkol2gilCNZ0ElY+bxS4WE2PQXfrA=",
        version = "v3.7.0",
    )
    go_repository(
        name = "io_periph_x_d2xx",
        importpath = "periph.io/x/d2xx",
        sum = "h1:aR+hMkz57YbQHR+Rji4jHH43YLTITRZUr2HjhqCYa7k=",
        version = "v0.1.0",
    )
    go_repository(
